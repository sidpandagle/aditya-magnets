...
export const categories: Record<string, Category> = {
  "fridge-magnets": {
    ...
    description:
      "Strong, vivid and customizable magnet styles for everyday display on your fridge or workspace.",
    products: [
      { slug: "classic-square-fridge-magnets", name: "Classic Square", price: 0, rating: 5, isPopular: true },
      { slug: "mini-square-fridge-magnets", name: "Mini Squares", price: 0, rating: 4.9 },
      { slug: "photo-strip-fridge-magnets", name: "Photo Strip", price: 0, rating: 4.8, isPopular: true },
      ...
      { slug: "heart-shape-fridge-magnets", name: "Heart Shape", price: 0, rating: 4.9, isPopular: true },
      ...
      { slug: "polaroid-style-fridge-magnets", name: "Polaroid Style", price: 0, rating: 4.9, isPopular: true },
  ...
  "photo-magnets": {
    ...
    title: "Photo Magnets",
    description:
      "Turn your favorite snapshots into vibrant magnets—perfect for gifts, collections and mood walls.",
    products: [
      { slug: "vivid-gloss-photo-magnets", name: "Vivid Gloss", price: 0, rating: 5, isPopular: true },
      { slug: "soft-matte-photo-magnets", name: "Soft Matte", price: 0, rating: 4.9, isPopular: true },
      { slug: "edge-to-edge-photo-magnets", name: "Edge to Edge", price: 0, rating: 4.8 },
      { slug: "collage-photo-magnets", name: "Collage Grid", price: 0, rating: 4.8, isPopular: true },
      ...
      { slug: "framed-photo-magnets", name: "Framed Photo", price: 0, rating: 4.8, isPopular: true },
  ...
  "retro-prints": {
    ...
    title: "Retro Prints",
    description:
      "Vintage‑inspired magnet prints with classic frames and nostalgic color tones.",
    products: [
      { slug: "retro-square-set", name: "Retro Square Set", price: 0, rating: 5, isPopular: true },
      { slug: "polaroid-frame-magnets", name: "Polaroid Frame", price: 0, rating: 4.9, isPopular: true },
      ...
      { slug: "film-strip-retro-magnets", name: "Film Strip", price: 0, rating: 4.5, isPopular: true },
  ...
  "save-the-date": {
    ...
    title: "Save the Date",
    description:
      "Magnet keepsakes announcing your special day—memorable, durable and always visible.",
    products: [
      { slug: "minimal-save-the-date-magnet", name: "Minimal Modern", price: 0, rating: 5, isPopular: true },
      { slug: "script-elegant-save-the-date-magnet", name: "Elegant Script", price: 0, rating: 4.9, isPopular: true },
      { slug: "photo-collage-save-the-date-magnet", name: "Photo Collage", price: 0, rating: 4.8 },
      { slug: "bold-typography-save-the-date-magnet", name: "Bold Typography", price: 0, rating: 4.7, isPopular: true },
  ...
  "learn-and-make": {
    ...
    title: "Learn & Make",
    description:
      "DIY kits, tutorials and starter packs to help you create custom magnets and prints at home.",
    products: [
      ...
      { slug: "mini-polaroid-diy-kit", name: "Mini Polaroid Kit", price: 0, rating: 4.8, isPopular: true },
